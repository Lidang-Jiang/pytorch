...
class NVSHMEMSymmetricMemoryTest(MultiProcContinuousTest):
    ...
    @parametrize(
        ...
        [
            (torch.ops.symm_mem.nvshmem_put_with_signal, torch.ops.symm_mem.nvshmem_wait_for_signal),
            (torch.ops.symm_mem.shmem_put_with_signal, torch.ops.symm_mem.shmem_wait_for_signal),
        ],
    )
